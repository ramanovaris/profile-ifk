    ...
    <>
      ...
      <header
        className={cn(
          ...
          hasAnnouncement ? "top-0" : "top-4 px-4"
        )}
      >
        {hasAnnouncement && (
        ...
        <div className={cn(hasAnnouncement && "px-4 pt-2.5 sm:pt-3")}>
          <div className="pointer-events-auto mx-auto flex h-14 w-full max-w-4xl lg:max-w-5xl items-center justify-between rounded-full border border-black/5 bg-white/70 px-4 sm:px-5 shadow-[0_8px_32px_rgba(0,0,0,0.08)] backdrop-blur-xl">
            <Link
              href="/"
